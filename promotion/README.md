...
Ready-to-post content extracted from your book. Post every 2-3 days.
...
| Week | Day | Type | Source |
|------|-----|------|--------|
| 1 | Mon | Chapter story | Your strongest story |
| 1 | Thu | FAQ | A common question your book answers |
| 2 | Mon | Chapter story | Second strongest story |
| 2 | Thu | Template preview | Show a premium extra with screenshot |
| ... | ... | Alternate | Keep going for 12 weeks |

## Directory structure

```
promotion/
  chapter-posts/     # One .md file per post
  template-previews/ # Posts about premium extras, with images
  faq-posts/         # Standalone FAQ answers
